...
# --- pre-claim inert diagnostics ---------------------------------------------
# The 2026-09-15 episode: many consecutive Stop events left
...
# or the hook was never firing at all. These tests pin the record that answers
# that, and pin the ancestry field that separates the two ways an identity gate
# can reject a firing - which is the discriminator the investigation lacked.
